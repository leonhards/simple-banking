    ...
    <? else : ?>
        ...
        <form method="post" class="sbs-form" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
            ...
            <div style="white-space: nowrap; margin-top:40px;">
                <a href="<?php echo remove_query_arg('action', esc_URL(admin_url('admin.php?page=sbs-accounts'))); ?>" class="page-title-action" style="display: inline; top: 0; margin-right: 10px;">
